...
class JobItemDetails extends Component {
  ...
  getFormattedSimilarProductsData = e => ({
    companyLogoUrl: e.company_logo_url,
    employmentType: e.employment_type,
    id: e.id,
    jobDescription: e.job_description,
  ...
  getJobCardDetails = async () => {
    ...
    if (response.ok === true) {
      ...
      const updatedJobDetails = this.getFormattedJobDetailsData(
        data.job_details,
      )
      const updatedSimilarProductsData = data.similar_jobs.map(
        eachSimilarProduct =>
          this.getFormattedSimilarProductsData(eachSimilarProduct),
      )
      this.setState({
